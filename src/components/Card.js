  ...
  return (
    ...
    <div style={{ perspective: 2000 }}>
      ...
      <motion.div
        ...
        className="w-[75%] min-h-[90%] bg-[#e3e2df] rounded-[3%] border-[4px] border-white px-[3%] py-[3%] cursor-grab relative"
      >
        {/* card logo */}
        <div className="mb-6">
          <img src={LogoImg} alt="" />
        ...
        <p className="max-w-[300px] text-[#000000] mb-3">
          Your order made our day. We hope that makes yours ! Your support means
